...
<section class="profile-card" aria-labelledby="profile-security">
 ...
 <?php else:?>
 <p class="profile-note"><?=$factor?'Your authenticator adds a verification step when you sign in. Turning it off also removes your current recovery codes.':'Two-factor authentication is optional. You currently sign in with your password. Turn it on here to require an authenticator code at sign-in.'?></p>
