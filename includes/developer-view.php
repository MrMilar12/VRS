...
<section class="update-card">
 ...
 <div class="update-hero"><div class="update-symbol" aria-hidden="true"><svg viewBox="0 0 48 48" fill="none"><path d="M24 32V12m-8 8 8-8 8 8M12 30v7h24v-7" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div><h2>Better with every update.</h2><p class="developer-status" data-update-status role="status">Choose Check for updates to get started.</p><p class="update-description">Updates are manual. Check, download, and install when you’re ready.</p></div>
