...
function booking_parse_response(array $response): array {
 ...
 if(!in_array($intent,['booking','vehicles','drivers','system','conversation'])||!in_array($topic,['overview','approval','booking','editing','authenticator','calendar','dispatch','profile','availability','personnel','tracking','notifications','registration','reminders'])||!is_array($result['lookup']??[]))throw new RuntimeException('The assistant could not understand that request. Please try again.');
