...
?><!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Install VPRS · Workspace setup</title><link rel="stylesheet" href="assets/css/style.css"><script src="assets/js/setup.js" defer></script></head><body><main class="installation-shell"><a class="installation-brand" href="index.php">VPRS <span>VEHICLE &amp; PERSONNEL</span></a><div class="page-heading"><div><h1><?=$complete?'Your workspace is ready':'Install your VPRS workspace'?></h1><p>Connect your database, create an administrator, and get moving.</p></div></div>
