...
if(preg_match('#^/(?:login|register|two-factor|actions|api|export|setup|install)\.php$|^/print/(?:requisition|daily-schedule|personnel)\.php$#',$path)){require __DIR__.$path;return true;}
