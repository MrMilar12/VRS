...
(() => {
  ...
  try {
    ...
    svg.setAttribute('aria-label', `QR code for slip ${reference}`);
    ...
    button.textContent = 'QR code unavailable';
    status.textContent = 'Refresh the page to generate the QR code before printing.';
  }
})();
