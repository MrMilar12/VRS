...
document.querySelectorAll('form[data-confirm]').forEach(form=>form.addEventListener('submit',event=>{if(!form.hasAttribute('data-admin-confirm')&&!confirm(form.dataset.confirm))event.preventDefault();}));
