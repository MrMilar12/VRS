...
check_work(!work_reminders([],[$future],$today,3),'Future unstarted assignment does not crowd today');
check_work(count(work_reminders([],[array_replace($future,['status'=>'In Progress'])],$today,3))===1,'Assignment started early appears immediately');
